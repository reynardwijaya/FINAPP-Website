        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <form action="{{ route('categories.update', $category) }}" method="POST" class="p-6">
                ...
                <div class="space-y-6">
                    ...
                    <!-- Category Type (disabled for existing categories) -->
                    <div>
                        <label for="type" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Category Type</label>
                        <input type="text" value="{{ ucfirst($category->type) }}" disabled
                            class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-white bg-gray-100 dark:bg-gray-800 shadow-sm">
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-2">
                            ...
                            <input type="text" value="{{ old('color', $category->color) }}" id="colorText"
                    ...
                    <div>
                        ...
                        <div class="mt-1 flex items-center space-x-2">
                            ...
                            <div id="iconPreview" class="w-10 h-10 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                                <i class="{{ old('icon', $category->icon ?? 'fas fa-tag') }} text-gray-600 dark:text-gray-400"></i>
                            </div>
                        </div>
