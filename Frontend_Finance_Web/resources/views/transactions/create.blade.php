...
@section('title', 'Catat Transaksi - Finapp')

@section('content')
<div class="mx-auto max-w-2xl">
    <x-page-header title="Catat transaksi" subtitle="Isi data pemasukan atau pengeluaran usahamu." />
    ...
    <x-card padding="lg">
        <form action="{{ route('transactions.store') }}" method="POST" class="space-y-5">
            ...
            <div class="flex flex-col-reverse gap-3 pt-2 sm:flex-row sm:justify-end">
                <x-button :href="route('transactions.index')" variant="secondary">Batal</x-button>
